...
#define PORT_GPCLR(port, pin)   (BASE_ADDRESS_PORT(port) + 0x80)
#define PORT_GPCHR(port, pin)   (BASE_ADDRESS_PORT(port) + 0x84)
...
#define GPIO_PDIR(port)       	(BASE_ADDRESS_GPIO(port) + 0x10u)
